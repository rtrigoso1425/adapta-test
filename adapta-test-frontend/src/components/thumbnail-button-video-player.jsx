...
// Usamos <img> en lugar de next/image para compatibilidad fuera de Next.js
        ...
        <div className="flex items-center">
          ...
          <div className="relative w-[70px] h-[42px] rounded-lg overflow-hidden flex-shrink-0">
            <img
              ...
              onError={(e) => {
                // fallback si la miniatura falla
                if (e.currentTarget.src !== DEFAULT_VIDEO_THUMBNAIL) {
            ...
            {isYouTube && (
              <div
                className="absolute bottom-1 right-1 bg-red-600 text-white text-[8px] font-bold px-1 py-0.5 rounded">
                YT
              </div>
            )}
          </div>
