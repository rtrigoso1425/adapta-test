        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center p-4">
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-semibold text-white">Cargando malla curricular...</h3>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-black">
            ...
            <div className="bg-black text-white shadow-md">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4">
                    <Link 
                        to="/dashboard" 
                        className="inline-flex items-center gap-2 text-gray-300 hover:text-white transition-colors mb-3 group text-sm"
                    >
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-4 text-xs">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-gray-300">Coordinador:</span>
                                    <span className="font-semibold">{career.coordinator?.name || 'No asignado'}</span>
                                </div>
                                <div className="flex items-center gap-1.5">
                                    ...
                                    {cycle.courses && cycle.courses.length > 0 ? (
                                        <div className="grid gap-2">
                                            {cycle.courses.map((course, courseIndex) => (
                                                ...
                                                >
                                                    <div className="flex-shrink-0 w-8 h-8 rounded-md bg-white group-hover:bg-white/10 flex items-center justify-center font-bold text-xs border border-gray-200 group-hover:border-white/20">
                                                        {courseIndex + 1}
                                                    </div>
